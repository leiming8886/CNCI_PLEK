...
parse.add_option('-f','--files',dest='files',action='store',nargs="*",metavar='input files',help='enter your transcript (contain the transcript ID)')
...
parse.add_option('-g','--hg',dest='hg',action='store',metavar='ref_name',help='please enter hg38 or hg19')
#parse.add_option('-i','--t',dest='tiss',action='store_true',metavar='tissue name',help='please enter tissue name')
#parser.add_option('-p','--p', dest='samples', nargs="*",action='store',help='Sample names')
